...
def handle_client(client_socket, client_address):
    try:
        ...
        # Verificar si el cliente ya está en la lista de clientes conectados
        if nickname not in clients:
            # Guardar el nickname en el diccionario de clientes
            clients[nickname] = client_socket
            print(f"{nickname} se ha conectado.")
            save_nicknames()  # Guardar el estado de los clientes en el archivo inmediatamente

        # Notificar a todos los demás clientes que un nuevo cliente se unió
